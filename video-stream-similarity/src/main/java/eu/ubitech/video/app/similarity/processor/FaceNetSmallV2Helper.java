...
import eu.ubitech.video.app.util.EnvKeys;
...
import static eu.ubitech.video.app.similarity.processor.FaceNetSmallV2Model.paddingIndex;
import static eu.ubitech.video.app.similarity.processor.FaceNetSmallV2Model.reluIndex;

public class FaceNetSmallV2Helper {
    static final String BASE = System.getenv(EnvKeys.FACE_FOLDER.toString());
